...
<html>
	...
	<body>
		...
		<s:url value="/doFormMembro" var="acao" />
		<div class="container">
			<br/><br/>
			<h3><strong>Cadastro de Membro</strong></h3>
			<br/><br/>
			<sf:form method="post" modelAttribute="membro" action="${acao}">
				<c:if test="${not empty membro.id}">
					<sf:hidden path="id" />
				</c:if>
				<sf:hidden path="projeto.id" value="${idProjeto}"/>
